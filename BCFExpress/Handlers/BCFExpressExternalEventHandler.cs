...
namespace BCFExpress.Handlers
{
    public class BCFExpressExternalEventHandler : IExternalEventHandler
    {
        ...
        public void Execute(UIApplication app)
        {
            ...
            if (result is not (RequestId.GrowSectionBox or RequestId.ShrinkSectionBox))
                SetViewPointView();
        ...
        private void IsolateElement(View3D bcfView)
        {
            ...
            using (var trans = new Transaction(ActiveDoc))
            {
                ...
                try
                {
                    bcfView.IsolateElementTemporary(DB.SelectedComponent.ElementId);

                    var element = DB.SelectedComponent.RvtElement;
                    if (element != null)
                    {
        ...
        private bool SetViewPointView()
        {
            ...
            try
            {
                ...
                SetDefaultView();
                var visInfo = DB.SelectedMarkup.Viewpoints.FirstOrDefault().VisInfo;
